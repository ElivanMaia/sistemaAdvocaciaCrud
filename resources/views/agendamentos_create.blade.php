            ...
            <div class="form-card">
                ...
                <form action="{{ route('agendamentos.store') }}" method="POST" class="form-container">
                    ...
                    <div class="input-group">
                        ...
                        <input type="datetime-local" id="data" name="data" value="{{ old('data') }}" required>
                        @error('data')
                    ...
                    <div class="input-group">
                        ...
                        <textarea id="descricao" name="descricao" rows="3" placeholder="Digite a descrição do agendamento..." required>{{ old('descricao') }}</textarea>
                        @error('descricao')
                            <div style="color: red; font-size: 0.9rem; margin-top: 4px;">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="input-group">
                        ...
                        <select id="clientes_id" name="clientes_id" required>
                            <option value="" disabled {{ old('clientes_id') ? '' : 'selected' }}>Selecione um cliente</option>
                    ...
                    <div class="input-group">
                        ...
                        <select id="advogados_id" name="advogados_id" required>
                            <option value="" disabled {{ old('advogados_id') ? '' : 'selected' }}>Selecione um advogado</option>
                            @foreach ($advogados as $advogado)
                                <option value="{{ $advogado->id }}" {{ old('advogados_id') == $advogado->id ? 'selected' : '' }}>
                                    {{ $advogado->nome }}
                                </option>
                            @endforeach
                        </select>
